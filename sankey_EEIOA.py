...
refining_codes = refining_codes[refining_codes['target_stage'] == 'refining']
...
if highlight_LMIC == True: 
    country_colours = pd.read_excel("colours.xlsx", sheet_name='grouped') # grouped by industrial, LMIC and black boxes
else:
